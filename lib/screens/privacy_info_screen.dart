      ...
      body: ListView(
        ...
        children: const [
          _Section(
            ...
            title: '録音した音声データ・添付画像/動画について',
            body:
                '録音した音声ファイルや、メモに添付した画像・動画は、この端末の中'
                'にのみ保存されます。カメラで撮影した写真・動画も、その場で端末内に'
                'コピーされるだけで、外部には送信されません。\n'
                'メモの内容・録音データ・添付画像・動画が、開発者を含む外部の'
                'サーバーへ自動的に送信されることはありません。',
          ),
          _Section(
